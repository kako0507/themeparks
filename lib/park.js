...
const DefaultTimeFormat = 'YYYY-MM-DDTHH:mm:ssZ';

const SocksProxyAgent = require('socks-proxy-agent');
const HttpsProxyAgent = require('https-proxy-agent');

// park symbols
const s_parkName = Symbol();
const s_parkTimezone = Symbol();
const s_parkGeolocation = Symbol();
const s_parkTimeFormat = Symbol();
const s_parkDateFormat = Symbol();
    ...
    return new Promise(((resolve, reject) => {
      ...
      this.Cache.Get('waittimes').then((ridedata) => {
        ...
        // failed to fetch wait times, reject Promise
          reject(`Error fetching park wait times: ${err}`));
      });
    }));
  }
    ...
    return new Promise(((resolve, reject) => {
      ...
      this.Cache.Get('openingtimes').then((openingTimesData) => {
        ...
        // failed to fetch opening times, reject Promise
          reject(`Error fetching park opening times: ${err}`));
      });
    }));
  }
