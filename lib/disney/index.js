  ...
  getAccessToken() {
    ...
    return this.cache.wrap('accesstoken', () => new Promise(((resolve, reject) => {
      ...
      this.http({
        ...
        data: this.constructor.authString,
        ...
        const ttlExpiresIn = parseInt(data.expires_in, 10);
        ...
        this.log(`Fetched new WDW access_token ${data.access_token}, expires in ${data.expires_in}, caching for a maximum of ${expiresIn}`);
