...
// API settings
const api_baseURL = 'https://services.universalorlando.com/api/';
const api_appKey = 'AndroidMobileApp';
const api_appSecret = 'AndroidMobileAppSecretKey182014';
...
class UniversalPark extends Park {
  ...
  GetAccessToken() {
    ...
    return this.Cache.Wrap('accesstoken', () => new Promise(((resolve, reject) => {
      ...
      const signatureBuilder = crypto.createHmac('sha256', api_appSecret);
