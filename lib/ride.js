...
class Ride {
   ...
   * @param {String} options.rideName Ride name
   */
  constructor(options = {
    rideId: null,
    rideName: null,
    ...
    if (!options.rideName || !options.rideName) throw new Error('No ride name supplied to new ride object');

    this[symbolRideId] = options.rideId;
    this[symbolRideName] = options.rideName;
